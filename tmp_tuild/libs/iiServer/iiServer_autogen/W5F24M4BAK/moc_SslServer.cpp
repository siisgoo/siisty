/****************************************************************************
** Meta object code from reading C++ file 'SslServer.hpp'
**
...
#include <memory>
#include "../../../../../libs/iiServer/include/iiServer/SslServer.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'SslServer.hpp' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_SslServer_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_SslServer_t qt_meta_stringdata_SslServer = {
    {
QT_MOC_LITERAL(0, 9) // "SslServer"
...
const QMetaObject SslServer::staticMetaObject = { {
    ...
    qt_meta_stringdata_SslServer.offsetsAndSize,
    qt_meta_data_SslServer,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_SslServer_t
, QtPrivate::TypeAndForceComplete<SslServer, std::true_type>
