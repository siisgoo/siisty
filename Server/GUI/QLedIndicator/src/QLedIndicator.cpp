...
QSize QLedIndicator::sizeHint() const
{
    ...
    case Hide:
        ...
        break;
    case Left:
        width += mLedSize + sz.width() + mLayout->contentsMargins().left();
        height += mLedSize;
        break;
    case Top:
        width += mLedSize > sz.width() ? mLedSize : sz.width();
        height += mLedSize + sz.height() + mLayout->contentsMargins().top();
        break;
    case Right:
        width += mLedSize + sz.width() + mLayout->contentsMargins().right();
        height += mLedSize;
        break;
    case Bottom:
        width += mLedSize > sz.width() ? mLedSize : sz.width();
        height += mLedSize + sz.height() + mLayout->contentsMargins().bottom();
        break;
    }

    width += mLayout->contentsMargins().left() + mLayout->contentsMargins().right();
    height += mLayout->contentsMargins().top() + mLayout->contentsMargins().bottom();
