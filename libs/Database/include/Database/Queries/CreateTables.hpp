...
static const auto CREATE_ACCIDENTS_TABLE =
    R"( CREATE TABLE IF NOT EXISTS "Accidents" (
...
static const auto CREATE_ACCOUNTING_TYPE_TABLE =
    R"( CREATE TABLE IF NOT EXISTS "AccountingType" (
    "id" INTEGER NOT NULL UNIQUE,
    "name" TEXT NOT NULL UNIQUE,
    PRIMARY KEY("id","name") ))";

static const auto CREATE_ASSIGNED_EMPLOYEES_TABLE =
    R"( CREATE TABLE IF NOT EXISTS "AssignedEmployees" (
    "id" INTEGER NOT NULL,
    "employee_id" INTEGER NOT NULL,
    "guiltyPercent" DECIMAL(10, 3) NOT NULL,
    "usedAmmo" INTEGER,
    FOREIGN KEY("employee_id") REFERENCES
    "EmployeesAndCustomers"("id") ON DELETE RESTRICT,
    PRIMARY KEY("id") ))";

static const auto CREATE_CONTRACTS_TABLE =
    R"( CREATE TABLE IF NOT EXISTS "Contracts" ( "id" INTEGER NOT NULL UNIQUE, "assignedEmployees_id" INTEGER NOT
...
static const auto CREATE_DUTY_SCHEDULE_TABLE =
    R"( CREATE TABLE IF NOT EXISTS "DutySchedule" ( "emploee_id" INTEGER NOT NULL, "day" INTEGER NOT NULL,
...
static const auto CREATE_EMPLOYEES_AND_CUSTOMERS_TABLE =
    R"( CREATE TABLE IF NOT EXISTS "EmployeesAndCustomers" ( "id" INTEGER NOT NULL UNIQUE, "name" TEXT NOT NULL,
...
static const auto CREATE_ROLES_TABLE =
    ...
    FOREIGN KEY("commands_id") REFERENCES "roleCommands"("role_id") ON DELETE RESTRICT,
    PRIMARY KEY("id") ))";

static const auto CREATE_WAPONS_TABLE =
    R"( CREATE TABLE IF NOT EXISTS "Wapons" (
    "id" INTEGER NOT NULL UNIQUE,
...
static const auto CREATE_OBJECT_TYPE_TABLE =
    R"( CREATE TABLE IF NOT EXISTS "objectType" ( "id" INTEGER NOT NULL UNIQUE, "name" TEXT NOT NULL UNIQUE,
    "price" DECIMAL(10, 3) NOT NULL, PRIMARY KEY("id") )
    )";

static const auto CREATE_ROLE_COMMANDS_TABLE =
    R"( CREATE TABLE IF NOT EXISTS "roleCommands" (
